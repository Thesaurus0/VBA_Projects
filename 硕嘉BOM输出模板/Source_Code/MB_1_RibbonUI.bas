    ...
    Select Case control.id
        ...
        Case "btnPrint"
            Select Case sType
                ...
                Case "ENABLED":     val = True
                Case "ACTION":      Call subMain_Print
            End Select
        Case "tbtnShowshtRawData"
            Select Case sType
                Case "LABEL":   val = "显示/隐藏" & vbCr & "原始数据表"
            ...
            End Select
        Case "tbtnShowshtCabinet"
            Select Case sType
                Case "LABEL":   val = "显示/隐藏" & vbCr & shtCabinet.name
                ...
                'Case "ACTION":      Call fClearRefVariables
            End Select
        Case "tbtnShowshtDoor"
            Select Case sType
                Case "LABEL":   val = "显示/隐藏" & vbCr & shtDoor.name
                Case "IMAGE":   val = "FileSaveAsExcelXlsx"
                Case "SIZE":        val = "true"    'large=true, normal=false
                Case "SHOW_IMAGE":  val = "true"
                Case "SCREENTIP":    val = ""
                ...
                'Case "ACTION":      Call fClearRefVariables
            End Select
        Case "tbtnShowshtCabinetFrame"
            Select Case sType
                Case "LABEL":   val = "显示/隐藏" & vbCr & shtCabinetFrame.name
                Case "IMAGE":   val = "FileSaveAsExcelXlsx"
                Case "SIZE":        val = "true"    'large=true, normal=false
                Case "SHOW_IMAGE":  val = "true"
                Case "SCREENTIP":    val = ""
                ...
                'Case "ACTION":      Call fClearRefVariables
            End Select
        Case "tbtnShowshtHardwares"
            Select Case sType
                Case "LABEL":   val = "显示/隐藏" & vbCr & shtHardwares.name
                Case "IMAGE":   val = "FileSaveAsExcelXlsx"
                Case "SIZE":        val = "true"    'large=true, normal=false
                Case "SHOW_IMAGE":  val = "true"
                Case "SCREENTIP":    val = ""
