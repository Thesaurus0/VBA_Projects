...
Function fGetControlAttributes(control As IRibbonControl, sType As String, Optional ByRef val)
    ...
    Select Case control.id
        Case "btnGenReports"
            Select Case sType
                Case "LABEL":   val = "生成采购订单" & vbCr & "(按产品)"
            ...
            End Select
        Case "btnGenReportsSecond"
            Select Case sType
                Case "LABEL":   val = "基于检查后的采购订单" & vbCr & "生成供应商供货清单"
                Case "IMAGE":   val = "OpenStartPage"
                Case "SIZE":        val = "true"    'large=true, normal=false
                Case "SHOW_IMAGE":  val = "true"
                Case "SCREENTIP":    val = ""
        ...
        Case "tbtnShowshtPurchaseODRaw"
            ...
            End Select
        Case "tbtnShowshtVendorMaster"
            Select Case sType
                Case "LABEL":   val = "显示/隐藏" & vbCr & shtVendorMaster.name
        ...
        Case "tbtnShowshtPurchaseODByProduct"
            Select Case sType
                Case "LABEL":   val = "显示/隐藏" & vbCr & shtPurchaseODByProduct.name
                Case "IMAGE":   val = "FileSaveAsExcelXlsx"
                Case "SIZE":        val = "true"    'large=true, normal=false
                Case "SHOW_IMAGE":  val = "true"
                Case "SCREENTIP":    val = ""
